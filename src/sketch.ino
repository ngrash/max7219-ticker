...
void loop() {
  ...
  char msg[256];
  byte bytesRead = Serial.readBytesUntil('\0', msg, 255);
  msg[bytesRead] = '\0';
...
void scrollMessage(char* message) {
  int bufferSize = (strlen(message) * 5) + PADDING*2;
